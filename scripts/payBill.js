...
payNowBtn.addEventListener('click', (event) => {
    ...
    const paymentSelection = document.getElementById('payment-selection').value;
            ...
            <div class="flex justify-between p-5 items-center">
              <div class="">
                <div class="gap-3 flex justify-center items-center">
                  <img class="p-2 bg-slate-100 rounded-full" src="./resources/assets/purse1.png" alt="purse1">
                  <div>
                    <p class="text-[1rem] font-bold">৳ <span id="available-balance">${amount}</span></p>
                    <p class="text-[0.75rem] font-bold">${paymentSelection}</p>
                    <p class="text-[0.75rem]">A/C No: ${billerAccountNumber}</p>
                  </div>
                </div>
              </div>
